<script setup>
/* PLAN 4 — la chambre : lit, étagère, plante, tapis, et au centre le bureau
   avec son écran allumé. On entre par la fenêtre, à gauche. */
</script>
...
<template>
  <svg class="scene" viewBox="0 0 1600 900" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
    <defs>
      ...
      <radialGradient id="lampeHalo" cx="50%" cy="50%" r="50%">
        <stop offset="0%" stop-color="rgba(255,196,107,0.55)" />
        <stop offset="100%" stop-color="rgba(255,196,107,0)" />
      </radialGradient>
      <linearGradient id="ecranLueur" x1="0" y1="0" x2="0" y2="1">
    ...
    <g>
      ...
      <!-- l'écran, au centre exact du cadre -->
